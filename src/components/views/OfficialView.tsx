...
export default function OfficialView() {
    ...
    // Default ODTÜ Date: Dec 29, 2025 (Month is 11)
    let start = new Date(2025, 11, 29); 
    
    if (isGlobalMode) {
         // Global Start Date: Jan 20, 2026 (Month is 0 for Jan)
                ...
                {isGlobalMode ? (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl w-full text-left">
                           <div className="text-center w-full col-span-full py-10 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg border border-neutral-200 dark:border-neutral-700">
                                <Globe className="mx-auto mb-4 text-neutral-300 dark:text-neutral-600" size={48} />
                                <p className="text-neutral-500 dark:text-neutral-400 font-serif italic">Global duyurular çok yakında burada olacak.</p>
                           </div>
                        </div>
                    </motion.div>
                ) : showSkeleton ? (
                    <OfficialSkeletonContent />
                ) : (
                    <motion.div
                        key="odtu"
