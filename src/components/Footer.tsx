...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-neutral-900 mt-20 pb-12 transition-colors">
      ...
      <div className="w-full border-t-4 border-black dark:border-neutral-600 mb-1"></div>
      <div className="w-full border-t-2 border-black dark:border-neutral-600 mb-12"></div>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-1 space-y-4">
            <h3 className="text-4xl font-black font-serif uppercase tracking-tighter border-b border-black dark:border-neutral-600 pb-2 inline-block dark:text-white transition-colors">
              Univo
            </h3>
          ...
          <div className="md:col-span-1 border-l-0 md:border-l-2 border-black dark:border-neutral-600 pl-0 md:pl-8 dark:text-white transition-colors">
